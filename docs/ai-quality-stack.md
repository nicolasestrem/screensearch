...
Models are downloaded on first use and can consume up to 5 GB. Each embedding
stores provider, model, revision, dimension, and content hash. A changed model
contract clears incompatible vectors and queues a resumable reindex.
